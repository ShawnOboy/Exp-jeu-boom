...
namespace Fusion.XR.Shared
{
    ...
    public static class InputSystemExtensions
    {
         ...
         **/
        public static void EnableWithDefaultXRBindings(this InputActionProperty property, List<string> bindings = null, List<string> leftBindings = null, List<string> rightBindings = null, bool keepExistingBinding = false)
        {
            if (property.reference ==null && (property.action.bindings.Count == 0 || keepExistingBinding ))
            {
